...
export const user32 = ffi.Library('user32', {
  ...
  FindWindowW: [NativeTypes.HANDLE, [NativeTypes.LPCWSTR, NativeTypes.LPCWSTR]],
  FindWindowExW: [NativeTypes.HANDLE, [NativeTypes.HANDLE, NativeTypes.HANDLE, NativeTypes.LPCWSTR, NativeTypes.LPCWSTR]],
  GetWindowTextW: [NativeTypes.INT, [NativeTypes.HANDLE, NativeTypes.LPCWSTR, NativeTypes.INT]]
})
